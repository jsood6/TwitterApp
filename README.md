...
- added color to the navigation bar to make it closer to the actual twitter app

Please list two areas of the assignment you'd like to **discuss further with your peers** during the next class (examples include better ways to implement something, how to extend your app in certain ways, etc):

1. Just check out whatever extra tasks other people did! 
2. Wanted to understand how to add the twitter logo to the navigation bar (I tried to do it, but the logo image looked kinda stretched lol)

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://imgur.com/a/9YCjs.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
Just figuring out how to add images to the file was pretty tricky for me! I had to use AlamofireImage instead of just Alamofire as recommended. 
...
- [x] List anything else that you can get done to improve the app functionality!
added the ability to refresh for tweets in the profile page as well!

Please list two areas of the assignment you'd like to **discuss further with your peers** during the next class (examples include better ways to implement something, how to extend your app in certain ways, etc):

1. see what extra credit stuff other people did :)
2. none
...
<img src='http://g.recordit.co/A4kbQnIrRT.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

Describe any challenges encountered while building the app: not really much.
